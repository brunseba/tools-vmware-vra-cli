"""Analytics router for VMware vRA statistics and metrics."""
...
async def get_analytics_stats(
    ...
    try:
        ...
        success_rate = ((total_deployments - failed_deployments) / total_deployments * 100) if total_deployments > 0 else 0.0
